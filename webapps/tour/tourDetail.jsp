    ...
    <div class="container">
      <h1 class="title">${dto.place } 상세보기</h1>
		...
		<div style="clear:both; margin-bottom:20px; padding-bottom:20px; ">
			...
			<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=87d59325b29b9b5b02d26229a3352731&libraries=services"></script>
			<script>
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			    mapOption = { 
			        center: new kakao.maps.LatLng(38, 128), // 지도의 중심좌표
			        level: 3 // 지도의 확대 레벨
			    };  
