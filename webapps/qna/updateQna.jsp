  ...
  <section class="section">
    	<div class="container">
			...
			<form name="frm1" id="frm1" action="${path1 }/UpdateQnaProCtrl.do" method="post">
				...
				<div class="btn-group">
					<input type="submit" value="글 변경" class="button is-dark">
					<a href="${path1 }/GetQnaListCtrl.do" class="button is-dark">목록으로</a>
					<a href="${path1 }/DeleteQnaCtrl.do?no=${vo.no }" class="button is-dark">글 삭제</a>
				</div>
			</form>
		</div>	
	</section>
