    ...
    <div class="container">
		...
		<div class="btn-group">
			...
			<c:if test='${sid eq "admin" }'>
				...
				<c:if test="${vo.lev eq 0 }">
					<a href='QnaReplyWriteCtrl.do?no=${vo.no }' class="button is-dark">답변 하기</a>
					<a href='UpdateQnaCtrl.do?no=${vo.no }' class="button is-dark">글 수정</a>
					<a href='DeleteQnaCtrl.do?parno=${vo.no }' class="button is-dark">글 삭제</a>
				</c:if>	
				<c:if test="${vo.lev eq 1 }">
					<a href='UpdateQnaCtrl.do?no=${vo.no }' class="button is-dark">답글 수정</a>
					<a href='DeleteQnaCtrl.do?no=${vo.no }' class="button is-dark">답글 삭제</a>
				</c:if>	
			</c:if>	
